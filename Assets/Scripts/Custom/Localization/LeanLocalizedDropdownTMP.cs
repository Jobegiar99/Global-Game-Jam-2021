...
namespace Lean.Localization
{
    ...
    [HelpURL(LeanLocalization.HelpUrlPrefix + "LeanLocalizedDropdownTMP")]
    [AddComponentMenu(LeanLocalization.ComponentPathPrefix + "Localized Dropdown TMP")]
    public class LeanLocalizedDropdownTMP : MonoBehaviour, ILocalizationHandler
    {
        [System.Serializable]
        public class Option
        {
        ...
        {
            options.ForEach(option => Options.Add(new Option() { StringTranslationName = option }));
            UpdateLocalization();
        }
        ...
        public void UpdateLocalization()
        {
            ...
            if (options != null)
            {
                for (var i = 0; i < options.Count; i++)
                {
                    ...
                    TMP_Dropdown.OptionData dOption;
                    if (dOptions.Count == i)
                    {
